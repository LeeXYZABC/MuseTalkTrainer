...
class VAE():
    ...
    def __init__(self, model_path="./models/sd-vae-ft-mse/", resized_img=256, use_float16=False, device="cpu"):
        """
    ...
    def get_latents_for_training(self, img):
        """
        Prepare latent variables for a U-Net model.
        :param img: The image to process.
        :return: A concatenated tensor of latents for U-Net input.
